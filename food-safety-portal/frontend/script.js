...
if (suggestionForm) {
    suggestionForm.addEventListener("submit", async (e) => {
        e.preventDefault();
        const data = Object.fromEntries(new FormData(suggestionForm).entries());
        try {
...
/* ======= LOAD REPORTS TABLE (restaurants.html) ======= */
...
/* ======= LOAD SUGGESTIONS TABLE (optional if you have a table) ======= */
